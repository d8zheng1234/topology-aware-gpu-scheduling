...
| Typed GPU/NIC/NUMA topology graph | Implemented; synthetic fixtures | [Graph API and boundaries](topology-graph.md), [tests](../tests/test_topology.py); legacy GPU-only loading, typed evidence, and categorical affinity queries; no device binding. |
