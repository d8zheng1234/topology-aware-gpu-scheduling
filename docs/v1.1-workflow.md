...
Instead of typing `links`, a controlled measurement run can produce it; see
[inter-node link measurement](link-measurement.md). Measured values are
time-scoped evidence and must be refreshed under an explicit maximum age.
