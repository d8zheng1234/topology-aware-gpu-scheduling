...
GPU-to-NUMA-to-NIC host locality, a Ray execution adapter, and a KAI Scheduler
lifecycle adapter. It is an experimental foundation: real GPU benchmarks,
workload traces, a typed affinity graph, and measured inter-node links are not
yet included. The
